          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input defaultValue="Sarah" className="bg-secondary/30 border-border/50" />
              </div>
              <div>
            ...
            <div>
              <Label>Email</Label>
              <Input defaultValue="sarah.johnson@university.edu" className="bg-secondary/30 border-border/50" />
            </div>
            <div>
              <Label>Department</Label>
              <Input defaultValue="Computer Science" className="bg-secondary/30 border-border/50" />
            </div>
          </div>
        </Card>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/30 border border-border/30">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Receive notifications for student messages</p>
              </div>
              <Switch 
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/30 border border-border/30">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Get weekly class performance summaries</p>
              </div>
              <Switch 
