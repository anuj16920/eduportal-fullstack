...
const FacultyCalendar = () => {
  ...
  const events = [
    ...
    { id: 3, title: "Upload Graph Theory Tutorial", type: "tutorial", date: "2025-12-03", time: "9:00 AM" },
    ...
    <DashboardLayout role="faculty">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Track your teaching schedule and deadlines</p>
        </div>
