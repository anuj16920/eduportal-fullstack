...
const AdminChat = () => {
  ...
  const [groups, setGroups] = useState([
    { id: 1, name: "All Faculty", members: 12, unread: 3 },
    { id: 2, name: "All Students", members: 186, unread: 8 },
    { id: 3, name: "Announcements", members: 198, unread: 0 },
  ]);
  const [selectedGroup, setSelectedGroup] = useState(groups[0]);
  const [messages, setMessages] = useState([
    { id: 1, sender: "Dr. Sarah", text: "Next faculty meeting scheduled for Friday", time: "9:30 AM" },
    { id: 2, sender: "Prof. Mike", text: "I'll prepare the presentation", time: "10:15 AM" },
    { id: 3, sender: "You", text: "Great! Looking forward to it.", time: "10:17 AM" },
  ]);
