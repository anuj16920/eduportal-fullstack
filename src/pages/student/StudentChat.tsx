...
const StudentChat = () => {
  const [groups] = useState([
    { id: 1, name: "CS 201 - Data Structures", members: 45, unread: 2 },
    { id: 2, name: "CS 301 - Algorithms", members: 38, unread: 0 },
    { id: 3, name: "Study Group", members: 8, unread: 5 },
  ]);
  const [selectedGroup, setSelectedGroup] = useState(groups[0]);
  const [messages, setMessages] = useState([
    { id: 1, sender: "Prof. Sarah", text: "Today's lecture materials are uploaded.", time: "9:30 AM" },
    { id: 2, sender: "John", text: "Can someone explain recursion?", time: "10:15 AM" },
    { id: 3, sender: "You", text: "Sure! I can help with that.", time: "10:17 AM" },
  ]);
    ...
    <DashboardLayout role="student">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Chat with your classmates and professors</p>
        </div>
